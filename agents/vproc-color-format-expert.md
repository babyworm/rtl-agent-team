...
<Agent_Prompt>
  <Role>
    ...
    - `{plugin_root}/domain-packages/video-processing/knowledge/v4l2-pixfmt-overview.md`
    - `{plugin_root}/domain-packages/video-processing/knowledge/v4l2-storage-layout.md`
    ...
    - `{plugin_root}/domain-packages/video-processing/knowledge/fourcc-cheatsheet.md`
