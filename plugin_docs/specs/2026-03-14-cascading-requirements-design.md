...
**Codex Cross-Review Stability** — Review is considered stable only after 2+ consecutive rounds of agreement between Claude and Codex. Single-round agreement is insufficient.
...
Stability criterion:
  - 2+ consecutive rounds of agreement = stabilized
