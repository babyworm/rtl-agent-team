...
|--------|-------------|---------|
| **rtl-agent-team** | 94-agent RTL design pipeline (Research → Architecture → μArch → RTL → Verify → Design Note) | 0.8.7 |
...
├── skills/                              # rtl-agent-team skills (93, with 13 reference docs)
├── plugins/
