...
|--------|-------------|---------|
| **rtl-agent-team** | 99-agent RTL design pipeline (Research → Architecture → μArch → RTL → Verify → Design Note) | 0.14.5 |
...
per-seed and aggregate JSON reports; it does not generate replay scripts.
