...
├── agents/                              # 85 specialized agent definitions (.md)
├── skills/                              # 85 skills: 47 action entry-points + 28 policies + 4 tool profiles + 4 conventions + 2 internal
...
## Native Team Mode (v0.6.5) — Orchestrator as Teammate Pattern
