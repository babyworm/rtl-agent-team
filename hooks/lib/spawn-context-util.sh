...
sctx_skill_to_phase() {
  case "$1" in
    ...
    rtl-p4-implement|rtl-p4-implement-team|rtl-p4-block-parallel|rtl-p4s-bugfix|rtl-p4s-unit-test|rtl-p4s-refactor|rtl-p4-rapid-impl|rtl-review-refactor) echo 4 ;;
