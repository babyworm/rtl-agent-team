...
Task(subagent_type="rtl-agent-team:eda-runner",
     prompt="Bind sim/formal/axi4_assertions.sv to rtl/axi_slave/axi_slave.sv. Run cocotb regression via Bash CLI with assertions enabled: make -C sim/axi_slave SIM=verilator TOPLEVEL=axi_slave MODULE=test_axi_slave. Report all assertion violations with cycle numbers.")
```
</Tool_Usage>
