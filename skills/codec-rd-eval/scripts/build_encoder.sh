...
# Note: Shares build logic with codec-conformance-eval/scripts/build_decoder.sh.
...
usage() {
    ...
    echo "  output_binary  Path for the output encoder binary"
...
echo "=== codec-rd-eval: Building encoder ==="
echo "Source:  $SRC_DIR"
