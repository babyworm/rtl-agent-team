...
| Simulator | Make Command | Pros | Cons |
|-----------|-------------|------|------|
| Icarus Verilog | `make SIM=icarus` | Fast compile, good SV support | Slower simulation |
| Verilator | `make SIM=verilator EXTRA_ARGS="--trace-fst --timing"` | Fastest simulation, FST traces | Stricter SV subset |
| ModelSim/Questa | `make SIM=modelsim` | Full IEEE 1800, UVM | Commercial license |
| VCS | `make SIM=vcs` | Fastest, full IEEE 1800 | Commercial license |
