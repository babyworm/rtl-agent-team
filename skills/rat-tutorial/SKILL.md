...
**Priority order:**
1. If the user appends a language name (e.g., `/rtl-agent-team:rat-tutorial Korean`), use that language
2. Otherwise, present the tutorial in the language the user is communicating in

Technical terms and command names (skill names, CLI commands, directory paths) remain in English,
but all explanations and descriptions are translated to the target language.
